...
uniform vec4 unf22;
const float cons24 = float(1.000000);
const vec4 cons28 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
const vec4 cons32 = vec4(1.000000, 1.000000, 1.000000, 0.000000);
uniform vec3 unf35;
uniform float unf39;
const float cons49 = float(1.000000);
uniform vec4 unf52;
const float cons54 = float(1.000000);
const vec4 cons58 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
const vec4 cons62 = vec4(1.000000, 1.000000, 1.000000, 0.000000);
const float cons65 = float(1.000000);
...
void main(void)
{
	...
	set_rgb_zero(tmp3);
	lamp_visibility_other(varposition, unf5, tmp6, tmp7, tmp8);
	lamp_falloff_invsquare(unf9, tmp7, tmp11);
	lamp_visibility_clamp(tmp11, tmp13);
	shade_inp(tmp2, tmp6, tmp16);
	shade_visifac(tmp16, tmp13, cons19, tmp20);
	shade_mul_value(tmp20, unf22, tmp23);
	mtex_value_invert(cons24, tmp25);
	mix_mult(tmp25, tmp23, cons28, tmp29);
	shade_madd(vec4(tmp3, 1.0), tmp29, cons32, tmp33);
	lamp_visibility_other(varposition, unf35, tmp36, tmp37, tmp38);
	lamp_falloff_invsquare(unf39, tmp37, tmp41);
	lamp_visibility_clamp(tmp41, tmp43);
	shade_inp(tmp2, tmp36, tmp46);
	shade_visifac(tmp46, tmp43, cons49, tmp50);
	shade_mul_value(tmp50, unf52, tmp53);
	mtex_value_invert(cons54, tmp55);
	mix_mult(tmp55, tmp53, cons58, tmp59);
	shade_madd(tmp33, tmp59, cons62, tmp63);
	mtex_alpha_to_col(tmp63, cons65, tmp66);
	shade_alpha_opaque(tmp66, tmp68);
	linearrgb_to_srgb(tmp68, tmp70);
