...
const float cons15 = float(0.500000);
const float cons16 = float(1.000000);
const float cons20 = float(1.000000);
const float cons25 = float(1.000000);
const float cons26 = float(1.000000);
const float cons28 = float(1.000000);
const vec3 cons35 = vec3(0.050876, 0.050876, 0.050876);
...
void main(void)
{
	...
	vcol_attribute(var0, tmp2);
	srgb_to_linearrgb(tmp2, tmp4);
	texco_uv(var1, tmp6);
	mtex_image(tmp6, samp0, tmp9, tmp10);
	set_rgba(tmp10, tmp12);
	srgb_to_linearrgb(tmp12, tmp14);
	math_multiply(cons15, cons16, tmp17);
	mtex_rgb_mul(tmp4.rgb, tmp14.rgb, cons20, tmp17, tmp22);
	mtex_alpha_from_col(tmp10, tmp24);
	mtex_value_mul(cons25, cons26, tmp24, cons28, tmp29);
	mtex_value_clamp(tmp29, tmp31);
	mtex_alpha_to_col(vec4(tmp22, 1.0), tmp31, tmp34);
	shade_world_mix(cons35, tmp34, tmp37);
	shade_alpha_opaque(tmp37, tmp39);
	linearrgb_to_srgb(tmp39, tmp41);
